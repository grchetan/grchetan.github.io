...
export async function getLeetCodeStats(username = "chetanprajapat07"): Promise<LeetCodeStats> {
  ...
  // Array of potential endpoints: Vercel/Local Serverless API, CORS Proxies, direct fallback
  const endpoints = [
    "/api/leetcode",
